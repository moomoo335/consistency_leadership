...
export default function AumanDump() {
  const models = [
    {
      name: '欧曼EST-A自卸车',
      description: '重型自卸，矿山运输利器',
      image: '/auman-truck.jpg',
    },
    {
      name: '欧曼GTL自卸车',
      description: '高效自卸，工程运输专家',
      image: '/auman-truck.jpg',
    },
    {
      name: '欧曼ETX自卸车',
      description: '经济实用，建筑工地首选',
      image: '/auman-truck.jpg',
    },
  ];
    ...
    <div className="min-h-screen bg-slate-50">
      <section className="relative text-white py-32 mt-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="max-w-4xl">
            <h1 className="text-6xl font-bold mb-6">欧曼自卸车</h1>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-gray-700 text-lg leading-relaxed text-center max-w-3xl mx-auto">
              欧曼自卸车系列专为重载工程和矿山运输设计，
              采用超强车架结构和高强度货箱，承载能力出众。
              配备先进的液压举升系统，卸货快速高效，
              是矿山开采和大型工程建设的强力助手。
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-slate-900 to-red-900 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-6">准备购买欧曼自卸车？</h2>
