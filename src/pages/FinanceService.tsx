...
import { DollarSign, FileText, CheckCircle, Clock, CreditCard, Shield, Users, Phone, ChevronRight } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-50">
      <section className="relative bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 text-white py-24 mt-20">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-5xl font-bold mb-6">金融服务</h1>
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            提供灵活的金融方案和专业购车咨询，助力您的商用车采购
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 mb-4">金融贷款方案</h2>
