...
export default function ChenglongTractor() {
  const models = [
    {
      name: '乘龙H7',
      description: '旗舰级牵引车，高效长途运输',
      image: '/chenglong-truck.jpg',
    },
    {
      name: '乘龙H5',
      description: '中高端牵引车，性价比优选',
      image: '/chenglong-truck.jpg',
    },
    {
      name: '乘龙M3',
      description: '经济型牵引车，城际运输首选',
      image: '/chenglong-truck.jpg',
    },
  ];
    ...
    <div className="min-h-screen bg-slate-50">
      <section className="relative text-white py-32 mt-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="max-w-4xl">
            <h1 className="text-6xl font-bold mb-6">乘龙牵引车</h1>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-gray-700 text-lg leading-relaxed text-center max-w-3xl mx-auto">
              乘龙牵引车系列采用先进的动力系统和智能驾驶技术，
              为长途干线运输提供强劲动力和卓越燃油经济性。
              经过严格的质量检测，确保每一台车都能在各种复杂路况下稳定运行，
              是长途物流运输的理想选择。
            </p>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-br from-slate-900 to-blue-900 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-6">准备购买乘龙牵引车？</h2>
